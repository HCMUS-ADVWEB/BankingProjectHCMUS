...
public interface DebtService {
    ...
    ApiResponse<CreateDebtReminderResponse> createDebtReminder(UUID creatorId, CreateDebtReminderRequest request);
    
    

    ApiResponse<Void> payDebtReminder(UUID reminderId, PayDebtRequest request);
